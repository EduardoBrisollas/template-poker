...
(function () {
	...
	$(function () {
		...
		function checkNavbarVisibility() {
			if (window.scrollY === 0) {
				navbar.style.display = 'none'; // Oculta a barra de navegação quando o topo da tela é alcançado
			} else {
				navbar.style.display = 'block'; // Mostra a barra de navegação quando não estiver no topo da tela
			}
		}
